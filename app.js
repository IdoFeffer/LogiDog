...
function riskReasons(shipment) {
  ...
  // 5) Dwell: above baseline 90% + buffer OR (no baseline and ≥ fallback)
...
const SAMPLE_THREE = [
  ...
  },
  {
    ...
    "owner": "Ops-East",
    "last_update_timestamp": "2025-09-07T10:05:00Z"
  },
  {
    ...
    "owner": "LM-Central",
    "last_update_timestamp": "2025-09-05T09:58:00Z"
  }
]
...
function demoThree() {
  for (var i = 0; i < SAMPLE_THREE.length; i++) {
    var shipment = SAMPLE_THREE[i]
    var reasons = riskReasons(shipment)
    var atRisk = reasons.length > 0
    console.log(
      '%s  at_risk=%s  reasons=%s',
